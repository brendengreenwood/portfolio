...
import { Clock, TrendingUp, SmileIcon, Database, NetworkIcon, Timer } from 'lucide-react';
...
export default function CaseStudy() {
  ...
  const metrics = [
    ...
    },
    {
      ...
      description: "Enabled activation for all advertisers, not just high-value accounts."
    },
    {
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="mb-16">
            <div className="text-sm text-gray-600 mb-6">
              Case Studies / Cerebro Campaigns / Menu Item #1
            </div>
            <h1 className="text-5xl font-bold text-gray-900 mb-4">Roundel Campaign Manager</h1>
            ...
            <div className="prose prose-gray max-w-none">
              <p className="text-xl text-gray-700 leading-relaxed">
                Roundel Campaign Manager is an internal ad operations tool designed to streamline 
                campaign planning, segmentation, and execution across multiple platforms. This case 
                study outlines the development process, design challenges, and outcomes, highlighting 
                how Cerebro transformed campaign efficiency, business growth, and user satisfaction 
                through a data-centric, user-focused approach.
              </p>
            </div>
          </div>
